...
const RouteError = taggedSum('RouteError', {
  Expected: ['a', 'b'],
  ExpectedEndOfPath: ['a'],
  MissingParam: ['a'],
  EndOfPath: [],
...
const RouteResult = taggedSum('RouteResult', {
  Fail: ['routeError'],
...
const RouteParser = taggedSum('RouteParser', {
  Alt: ['a'],
  Chomp: ['c'],
  Prefix: ['a', 'b'],
});
...
const RouteDuplex = tagged('RouteDuplex', ['enc', 'dec']);
...
const Product = tagged('Product', ['a', 'b']);

const NoArguments = tagged('NoArguments', []);
