...
var immutagen = require('immutagen');
...
var immutagen__default = /*#__PURE__*/_interopDefaultLegacy(immutagen);
...
var TAG = '@@tag'; // * array of arguments used to create a value (to speed up `cata`)

var VALUES = '@@values'; // * `@@type` of its returned results

var TYPE = '@@type'; // * `@@type` of variant constructor's returned results

var RET_TYPE = '@@ret_type'; // * names of all variants of a sum type
...
function tagged(typeName, fields) {
  ...
  proto[SHOW] = tagged$toString; // this way we avoid named function
...
var go = function go(generator) {
  return rec2(immutagen__default["default"](generator)());
};
...
var fresh = ramda.curry(function (f, ref) {
  return go( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var st;
  ...
  return function (command) {
    ...
    return command.cata({
      State: function State(fn) {
        return go( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      ...
      Subscribe: function Subscribe(es) {
        return go( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      ...
      Unsubscribe: function Unsubscribe(sid) {
        return go( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    ...
    return mkComponent({
      ...
      evalFn: mkEval({
        ...
        handleAction: function handleAction(a) {
          return a.cata({
            Initialize: function Initialize() {
              return go( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
                var store;
...
var createHaloProvider = function createHaloProvider(_ref8) {
  ...
  return go( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
