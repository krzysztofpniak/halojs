...
const HalogenQ = daggy.taggedSum('HalogenQ', {
  Initialize: [],
  Action: ['action'],
  Receive: ['input'],
  Query: ['query'],
...
const HalogenF = daggy.taggedSum('HalogenF', {
  State: ['fn'],
  Lift: ['future'],
  Subscribe: ['esc'],
  Unsubscribe: ['sid'],
...
const ForkId = daggy.tagged('ForkId', ['id']);
const SubscriptionId = daggy.tagged('SubscriptionId', ['id']);
...
const ConnectAction = daggy.taggedSum('ConnectAction', {
  Initialize: [],
  Receive: ['input'],
  Update: ['context'],
  Raise: ['output'],
...
const taggedSum = daggy.taggedSum;
